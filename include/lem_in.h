...
/*   Updated: 2020/02/06 13:52:49 by dygouin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					permanant_delink(t_salle *room, t_stack *find,
	unsigned long index);
...
int						toplink(t_out *link, t_stack *find, t_salle *room,
	unsigned long index);
...
void					transfert_true(t_salle *room, t_stack *find,
	unsigned long salle);
int						verify_colision(t_salle *room, unsigned long salle,
	t_stack *find);
void					affichage(t_salle *room, t_stack *find);
int						create_room(t_salle *room, char *hash, t_out **n_index);
int						check_lformat(char *to_check, t_salle **rooms,
	int truth);
...
void					check_insert(t_out **reads, t_out **index,
						t_salle **rooms, t_stack *info);
...
void					algo(t_salle *room, t_stack *find, t_out *index,
	t_path *current);
int						bfs(t_salle *room, t_stack *find,
	unsigned long position, t_out **stack);
